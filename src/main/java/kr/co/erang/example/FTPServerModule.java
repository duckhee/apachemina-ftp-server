...
public class FTPServerModule {
    ...
    //  private static final String FTPSERVER_USER_FOLDER = "C:\\Users\\CANDH105\\Desktop\\workspace\\00.test\\testFTPTemp";
    private static final String FTPSERVER_USER_FOLDER = "/Users/duckheewon/Desktop/temp";
    private static final int FTPSERVER_PORT = 3232;
...
/*
        ...
        if (this.ftpProtocol.equals("ftps")) {
            ...
            if (keyStoreFile.exists()) {
                ...
                log.info("The KeyStore file does not exists in /opt/ftpserver");
                return false;
            }
...
*/
        ...
        if (!dir.exists() && !dir.mkdirs()) {
            log.info(String.format("Can't create users directory (%s).", FTPSERVER_USER_FOLDER));
            return false;
        }
    ...
    /*if (dir.exists()) {
      try {
        ...
        log.info("get base user ::: {}", baseUser.toString());
        return baseUser;
    }
